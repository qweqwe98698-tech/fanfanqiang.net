...
const targetFile = path.join(__dirname, 'build_client_guide_article.js');
...
fs.writeFileSync(targetFile, newScript);
console.log('Successfully updated build_client_guide_article.js');
